...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  private migrate() {
    ...
    try { this.db.exec("ALTER TABLE database_connections ADD COLUMN connection_purpose TEXT NOT NULL DEFAULT 'backup'"); } catch {}
