...
export class DatabaseService implements OnModuleInit, OnModuleDestroy {
  ...
  private migrate() {
    this.db.exec(`
      ...
      CREATE TABLE IF NOT EXISTS backup_jobs (id TEXT PRIMARY KEY, name TEXT NOT NULL, database_connection_id TEXT NOT NULL REFERENCES database_connections(id) ON DELETE CASCADE, storage_target_id TEXT NOT NULL REFERENCES storage_targets(id) ON DELETE CASCADE, database_scope TEXT NOT NULL DEFAULT 'selected', database_names TEXT NOT NULL DEFAULT '[]', backup_layout TEXT NOT NULL DEFAULT 'single', cron_expression TEXT NOT NULL, timezone TEXT NOT NULL DEFAULT 'UTC', enabled INTEGER NOT NULL DEFAULT 1, compression TEXT NOT NULL DEFAULT 'gzip', backup_encryption TEXT NOT NULL DEFAULT 'none', retention_count INTEGER NOT NULL DEFAULT 7, filename_prefix TEXT NOT NULL, next_run_at TEXT, last_run_at TEXT, created_at TEXT NOT NULL);
