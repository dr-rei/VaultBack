...
function showJobForm(item = {}) {
  ...
  el.innerHTML = formShell(item.id ? 'Edit schedule' : 'Create schedule',
    ...
    selectField('Compression', 'compression', [['gzip', 'GZIP (.sql.gz)'], ['none', 'None (.sql)']], item.compression || 'gzip') +
